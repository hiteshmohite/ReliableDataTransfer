...
public class client {
     ...
     */
    public static void fcn_client(String[] args) throws SocketException, UnknownHostException, IOException,NoSuchAlgorithmException {
        // TODO code application logic here
        client_setup connect_server = new client_setup(args);
...
class client_setup
{
    ...
    int client_port = 0, server_port = 0, store_numerics = 0, time_limit = 0;
    int packet_count = 0;
    ...
    public client_setup(String[] params) throws SocketException, UnknownHostException, IOException, NoSuchAlgorithmException
    {
        args = params;
        client_port = Integer.parseInt(params[4]);
        time_limit = Integer.parseInt(params[1]);
        server_port = Integer.parseInt(params[5]);
